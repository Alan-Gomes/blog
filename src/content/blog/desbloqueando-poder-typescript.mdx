...
excerpt: Entenda como escrever tipos que expressem melhor o seu código e o torne mais previsível
tags: ['typescript']
---

import TypeScriptEditor from '@/components/editors/typescript/index.astro';

O TypesScript surgiu inicialmente como uma linguagem com o simples propósito de adicionar tipagem em cima do JavaScript.
